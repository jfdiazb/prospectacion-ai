...
export const crmService = {
  ...
  async aiUsage(): Promise<AiUsage> { const response = await apiClient.get('/crm/ai-usage'); return response.data.data; },
