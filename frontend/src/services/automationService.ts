...
export interface AutomationFlow { _id: string; name: string; description?: string; trigger: { type: string; keyword?: string }; actions: Array<{ type: string; message?: string }>; isActive: boolean; executionStats?: { totalExecutions?: number; successfulExecutions?: number; failedExecutions?: number; lastExecution?: string } }
