    ...
    return {
      ...
      runtime: {
        ...
        providers: {
          ...
          facebook: { inbound: inboundStatus('facebook', has('META_APP_SECRET', 'META_VERIFY_TOKEN')), outbound: outboundStatus('facebook', effectiveOutbound('facebook', facebookMode)), configured: facebookMode === 'mock' || has('META_PAGE_ACCESS_TOKEN', 'META_PAGE_ID'), automatic: process.env.FACEBOOK_AUTO_SEND_ENABLED === 'true' },
